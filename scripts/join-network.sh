...
if [ ! -d "NeoCoin" ]; then
    ...
    echo "NeoCoin already exists, pulling latest..."
    cd NeoCoin
...
# Run
echo ""
echo "Starting NeoCoin node..."
echo "=================================="
echo ""

# Run with seed
PEERS="$SEED" CHAIN_ID="$CHAIN_ID" DATA_DIR=./data ./neocoin server
