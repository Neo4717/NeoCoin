...
pkill -9 neocoin 2>/dev/null || true
sleep 2
...
# Cleanup
pkill -9 neocoin 2>/dev/null || true
rm -rf /home/neo/Download/Neocoin/node1_data /home/neo/Download/Neocoin/node2_data
